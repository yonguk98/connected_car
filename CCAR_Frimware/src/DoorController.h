...
private:
    ...
    static const int SERVO_MIN_PULSE_WIDTH = 500;   // Minimum pulse width for 0 degrees
    static const int SERVO_MAX_PULSE_WIDTH = 2400;  // Maximum pulse width for 180 degrees
